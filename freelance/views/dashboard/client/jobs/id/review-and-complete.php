...
<div class="container rounded-corners background-color-gray"
    ...
    <form action="/dashboard/client/jobs/id/review-and-complete?jobId=<?php echo $job->getId(); ?>" method="POST">
        <fieldset>
            ...
            <input class="button-red" type="submit" value="Reject"
                formaction="/dashboard/client/jobs/id/review-and-complete-reject?jobId=<?php echo $job->getId(); ?>"
                <?php if ($proposal->getStatus() != 'work submitted') { ?> disabled <?php } ?>>
