...
?>
    ...
    <!-------------------------------- job -------------------------------------------------------->
    <div class="container rounded-corners background-color-gray" style="padding-bottom:2px; padding-top:10px; margin-bottom:5px">
    ...
    <div class="container rounded-corners background-color-gray" style="padding-bottom:5px; padding-top:10px; margin-bottom:10px">
        ...
        <?php if (!$job->hasWorkSubmitted()) { ?>
            <form action="/dashboard/freelancer/jobs/id/submit-work?jobId=<?php echo $job->getId(); ?>" enctype="multipart/form-data" method="POST">
                <fieldset>
