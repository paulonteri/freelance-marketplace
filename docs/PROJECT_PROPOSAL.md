...
* Easy, fast and chap communication. It is easier, faster and cheaper to communicate with a person on the other side of the world today than one trying to communicate with someone in a nearby village a century ago. This allows people and businesses to strengthen interpersonal relationships. It allows easy self-expression for all kinds of people.
...
System Analysis: This will involve the description of the current systems, their strengths and weakness plus their feasibility study. We will figure out the data captured by the current system, and the relationship between the data outputs from the system. We will also deal with the design of the system.
